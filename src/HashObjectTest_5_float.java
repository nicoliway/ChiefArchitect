...
/**
 * Testing for instances of HashObject<Float> class.  
 *
 * @author CS 321
 */

public class HashObjectTest_5_float
{
	// HashObject object running tests on
	HashObject<Float> hashObject;
	
	//****** Constants used in tests *****************
	// Value in HashObject
	private static final Float VALUE = TestCase.F_12;  
	// Key for value in HashObject 
	private static final int KEY = TestCase.K_1;  
	// New value for HashObject
	private static final Float NEW_VALUE = TestCase.F_34; 
	// New key for HashObject
	private static final int NEW_KEY = TestCase.K_2;  
	// Equivalent HashObject for testing equality 
	private static final HashObject<Float> EQUAL_HASHOBJECT = new HashObject<Float>(VALUE, KEY); 
	// Another HashObject to test for equality   
	private static final HashObject<Float> NOTEQUAL_HASHOBJECT = new HashObject<Float>(TestCase.F_56, TestCase.K_3);  
	// Hash code for hashObject
	private static final long HASH_CODE = 1067031930; 
	...
	{
		// create HashObject
		hashObject = new HashObject<Float>(VALUE, KEY); 
